...
def predict():
    if request.method == 'POST':
        ...
        # head_to_head_team1 = df[((df['team1'] == team1) & (df['team2'] == team2))|((df['team1'] == team2) & (df['team2'] == team1))]['head to head ratio team1'].values[0]
        ...
        # team1_innings_win_ratio = df[df['venue'] == venue]['1st innings win ratio'].values[0]
        # team2_innings_win_ratio = df[df['venue'] == venue]['2nd innings win ratio'].values[0]
